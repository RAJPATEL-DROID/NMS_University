...
import static org.example.Bootstrap.*;
import static org.example.utils.Constant.*;
...
public class Server extends AbstractVerticle
{
    ...
    private void storeAlerts(String ipAddress, String message)
    {
        ...
        try(var conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(alertInsert);)
        {
